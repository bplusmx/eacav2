...
add_action('tgmpa_register', 'eacav2_theme_register_required_plugins');

/**
 * Plugins necesarios y recomendados para esta plantilla
 *
 */
function eacav2_theme_register_required_plugins() 
{
    // Change this to your theme text domain, used for internationalising strings
    $theme_text_domain = 'eacav2';
    ...
    $plugins = array(
        array(
            ...
            'external_url'     => 'https://bitbucket.org/luisabarca/wp-eacapulco/get/HEAD.zip'
        ),
        array(
